...
# Definir paleta de colores azules
colores_azules = [
    "#0D47A1",
    "#1565C0",
    "#1976D2",
    ...
    children=[
        ...
        html.Div(
            ...
            children=[
                ...
                # ℹ️ Columna derecha: descripción del sistema
                html.Div(
                    style={
                        "flex": "1",
        ...
        for col in columnas_modelo:
            if col in encoders:
                ...
                try:
                    ...
                    return (
                        f"⚠️ Valor inválido para '{col}': '{X_nuevo.at[0, col]}'. Valores válidos: {valores_validos}",
                        "",
                        {},
                        {"display": "none"},
                    )
